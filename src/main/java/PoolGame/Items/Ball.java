 ...
 */
public class Ball implements Drawable, Movable, Cloneable{
        ...
        this.shape.setOnMouseDragged(
            (actionEvent) -> {
                if (this.hasStopped()) {
                    ...
                    this.mouseDragLine.setStrokeWidth(5);
                    this.mouseDragLine.setStroke(Color.BURLYWOOD);
                }
            }
        );
    ...
    */
    ...
    public void fallIntoPocket(Game game) {
        ...
        if (this.colour.equals(Color.valueOf("red"))) {
            game.addScore(1);
        } else if (this.colour.equals(Color.valueOf("yellow"))) {
            game.addScore(2);
        } else if (this.colour.equals(Color.valueOf("darkgreen"))) {
            game.addScore(3);
        } else if (this.colour.equals(Color.valueOf("SADDLEBROWN"))) {
            game.addScore(4);
        } else if (this.colour.equals(Color.valueOf("blue"))) {
            game.addScore(5);
        } else if (this.colour.equals(Color.valueOf("purple"))) {
            game.addScore(6);
        } else if (this.colour.equals(Color.valueOf("black"))) {
            game.addScore(7);
        } else if (this.colour.equals(Color.valueOf("orange"))) {
            game.addScore(8);
        }
    }
}
