...
/** A pool table */
public class PoolTable implements Drawable, Cloneable {
    private long[] dim;
    ...
    private boolean cueBallMoved = false;
    ...
    public void setStateKeep(TableMementoCaretaker ballMementoCaretaker) {
        this.stateKeep = ballMementoCaretaker;
    }

    public boolean getCueBallMoved() {
        return cueBallMoved;
    }

    public void setCueBallMoved(boolean moved) {
        this.cueBallMoved = moved;
    }
    ...
    public void cheatRemove(Paint color, Game game) {
        for (Ball ball : balls) {
    ...
    public TableMemento createSnapshot() {
//        PoolTable cloneTable = this.clone();

        return new TableMemento(this);
    }

    @Override
    public PoolTable clone() {
        try {
            PoolTable clone = (PoolTable) super.clone();
